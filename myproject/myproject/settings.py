...
DEBUG = True
# To avoid getting an error page and a 404 page --- DEBUG = False
#True
...
# TIME_ZONE = 'UTC'
TIME_ZONE = 'Europe/Paris'  # Replace with your local timezone
...
AZURE_INSTRUMENTATION_KEY = os.getenv('APPLICATIONINSIGHTS_CONNECTION_STRING')
